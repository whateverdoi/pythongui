...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.clicked.connect(self.translation)

    def translation(self):
        content = self.textEdit.toPlainText()
        language = classify(content)
        lang = language[0]
        if lang == "zh":
            translation = Translator(to_lang="en")
            text = translation.translate(content)
            self.textBrowser.setText(text)
        else:
            translation = Translator(from_lang="en", to_lang="zh")
            translation.translate(content)
            self.textBrowser.setText(text)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "大佬为空的翻译软件"))
